...
“”“Tests for utils/language_utils.py”””
...
def test_language_instruction_english(self):
    """
    get_language_instruction() should return a short string
    for English — no need to specify language explicitly.
    """
...
def test_language_instruction_german(self):
    """
...
class TestGenerateMom:
“”“Tests for tools/mom_tools.py — generate_mom tool.”””
...
def _make_fake_thread(self):
    ...
    return [
        ...
        },
        {
            ...
            "body": (
                "Agreed. I will handle the design mockups by next Wednesday."
            ),
            "has_attachments": False,
            "is_draft": False,
        },
...
@pytest.mark.asyncio
async def test_generate_mom_from_thread(self):
    """
...
@pytest.mark.asyncio
async def test_generate_mom_from_single_email(self):
    """
...
@pytest.mark.asyncio
async def test_generate_mom_handles_error(self):
    """
...
class TestSaveMomAsDraft:
“”“Tests for tools/mom_tools.py — save_mom_as_draft tool.”””

```
@pytest.mark.asyncio
async def test_saves_mom_draft_successfully(self):
    """
...
class TestTrackFollowups:
“”“Tests for tools/followup_tools.py — track_followups tool.”””

```
def _make_old_email(self, days_old: int = 5) -> dict:
...
@pytest.mark.asyncio
async def test_identifies_overdue_emails(self):
    """
    ...
    fake_messages = [self._make_old_email(days_old=5)]
...
@pytest.mark.asyncio
async def test_returns_clear_when_no_followups(self):
    """
    track_followups() should return a positive confirmation
    when all emails have been replied to or are recent.
    """
    fake_profile = {"mail": "me@company.com", "userPrincipalName": "me@company.com"}
    # Email only 1 day old — below 3-day threshold
    fake_messages = [self._make_old_email(days_old=1)]
...
class TestCheckEmailReplied:
“”“Tests for tools/followup_tools.py — check_email_replied tool.”””

```
@pytest.mark.asyncio
async def test_detects_replied_email(self):
    """
...
@pytest.mark.asyncio
async def test_detects_unreplied_email(self):
    """
...
“”“Tests for tools/followup_tools.py — compose_followup tool.”””

```
@pytest.mark.asyncio
async def test_returns_instruction_with_sender_details(self):
    """
    compose_followup() should return an instruction containing
    the original sender's name and the language-matched prompt.
    """
    fake_email = {
        "id": "msg-001",
...
class TestAddTaskTodo:
“”“Tests for tools/followup_tools.py — add_task_todo tool.”””

```
@pytest.mark.asyncio
async def test_creates_todo_task_successfully(self):
    """
...
class TestAddTaskPlanner:
“”“Tests for tools/followup_tools.py — add_task_planner tool.”””

```
@pytest.mark.asyncio
async def test_returns_error_when_plan_id_missing(self):
    """
...
@pytest.mark.asyncio
async def test_creates_planner_task_successfully(self):
    """
    add_task_planner() should return confirmation when
    a Planner task is created successfully.
    """
    fake_result = {
...
class TestListTasks:
“”“Tests for tools/followup_tools.py — list_tasks tool.”””

```
@pytest.mark.asyncio
async def test_returns_task_table_for_todo(self):
    """
...
@pytest.mark.asyncio
async def test_returns_empty_message_when_no_tasks(self):
    """
    ...
    assert "empty" in result["display_table"].lower() or "No pending" in result["display_table"]
```
